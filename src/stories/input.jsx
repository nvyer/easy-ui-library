...
const textFieldInputStory = () => {
    const standartInput = `<TextFieldInput placeholder="Type text..." variant="standart"/>`;
    ...
    return (
      <>
        ...
        <div className="component-container">
          <p className="component-title">Standart</p>
          <TextFieldInput placeholder="Type text..." variant="standart" />
          <pre className="component-code">{standartInput}</pre>
        </div>
