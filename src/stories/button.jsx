...
const buttonStory = () => {
    const primaryButton = `<Button onClick={(e) => console.log(e)} buttonStyle="btn--primary--normal">
        Easy-UI
      </Button>`;
    ...
    const secondaryNormalButton = `<Button onClick={(e) => console.log(e)} buttonStyle="secondary--normal">
        Easy-UI
      </Button>`;
    ...
    const subtleNormalButton = `<Button onClick={(e) => console.log(e)} buttonStyle="subtle--normal">
        Easy-UI
      </Button>`;
    const subtleDestructiveButton = `<Button onClick={(e) => console.log(e)} buttonStyle="subtle--destructive">
        Easy-UI
      </Button>`;
    const isLoadingButton = `<Button onClick={(e) => console.log(e)} isLoading>
        Easy-UI
      </Button>`;
    const disabledButton = `<Button onClick={(e) => console.log(e)} disabled>
        Easy-UI
      </Button>`;
    return (
      <>
