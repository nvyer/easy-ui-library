...
const dropDownIcon = <svg xmlns="http://www.w3.org/2000/svg" style={{fill : "white"}} width="16" height="16" viewBox="0 -3 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg>
