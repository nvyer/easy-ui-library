...
export const Slider = ({
  ...
  const onMouseMove = event => {
    ...
    let left = (event.clientX - shift - sliderCoords.left) / sliderCoords.width * 100;
  ...
  const handleClick = e => {
    ...
    setProgressPercent(e.nativeEvent.layerX / (railRef.current.clientWidth / 100));
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: className ? className : "slider-root"
